...
%\VignetteDepends{surveillance, lattice, spdep, gsl, colorspace, ggplot2, animation, gridExtra, scales, rmapshaper, fanplot, hhh4contacts}
...
which is based on \CRANpkg{ggplot2} \citep{R:ggplot2}:
...
knitr::write_bib(
    c("MASS", "Matrix", "spdep", "colorspace", "scales", "gridExtra", "lattice", "sp", "ggplot2", "animation", "rmapshaper", "fanplot", "hhh4contacts"),
