...
%\VignetteDepends{surveillance, lattice, spdep, gsl, colorspace, gridExtra, scales, fanplot, hhh4contacts}
...
for (.pkg in tools::vignetteInfo("hhh4_spacetime.Rnw")$depends) {
...
Rbib <- knitr::write_bib(
    c("MASS", "Matrix", "spdep", "colorspace", "gridExtra", "lattice", "sp", "fanplot", "hhh4contacts"),
