...
%\VignetteDepends{surveillance, lattice, spdep, gsl, colorspace, animation, gridExtra, scales, fanplot}
...
Note that the extra flexibility of the random effects model comes at a price.
...
compared to the long-term forecast via a \pkg{fanplot} \citep{R:fanplot}:
...
knitr::write_bib(
    c("MASS", "Matrix", "spdep", "colorspace", "scales", "gridExtra", "lattice", "sp", "animation", "fanplot"),
