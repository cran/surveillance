...
test_that("Formatting date vectors with ISO8601 and UK conventions",
          expect_that(formatDate(d2,"W%V-%G / W%W-%Y / %d-%m-%Y"),
                      equals(c("W01-2001 / W01-2001 / 01-01-2001",
                               "W18-2002 / W17-2002 / 01-05-2002"))))

test_that("Formatting quarters", {
    expect_that(formatDate(d2,"%Q"), equals(c("1","2")))
    expect_that(formatDate(d2,"%q"), equals(c("1","31")))
    expect_that(as.character(d2 - as.numeric(formatDate(d2,"%q")) + 1),
