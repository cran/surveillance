...
\begin{abstract} \noindent
  ...
  The special case of \emph{spatio-temporal} \hhh\ models is covered
  in greater detail in \citet[Section~5]{meyer.etal2014}.
  %% the extra \code{vignette("hhh4\_spacetime")}
\end{abstract}
