...
Figure~\ref{fig:measlesPreds2_plot} shows a \pkg{fanplot} \citep{R:fanplot} of
...
@
Note that \code{quantile} and \code{confint} methods are also available
for \class{oneStepAhead} predictions.
...
\citet{meyer.held2015}. The associated \pkg{hhh4contacts} package
...
knitr::write_bib(
    c("MASS", "Matrix", "spdep", "colorspace", "scales", "gridExtra", "lattice", "sp", "animation", "fanplot", "hhh4contacts"),
